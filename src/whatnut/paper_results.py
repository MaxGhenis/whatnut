...
2. Speed - no MCMC sampling required to build the paper
3. Auditability - reviewers can inspect exact values used

The values were generated by running the full Bayesian model with
seed=42 and verified against the MCMC output. To regenerate, run
